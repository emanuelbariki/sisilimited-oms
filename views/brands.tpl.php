    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Brands Module</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-0">Add Brands</h4>
                    <hr>
                    <div class="col-md-12">
                        <form action="<?=url('brands','add')?>" method="post">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="country" placeholder="Country" name="brand[country]" value="<?=$country?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select id="statuss" class="form-control" name="brand[status]">
                            ...
                            <table class="table table-hover table-centered mb-0 table-nowrap" id="datatable-buttons">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="font-weight-medium">Brans Name</th>
