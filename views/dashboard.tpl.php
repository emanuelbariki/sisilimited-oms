                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-right">
                                    <h3 class="mt-1"> &nbsp; <span data-plugin="counterup">25</span></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-right">
                                    ...
                                    <p class="text-muted mb-1 text-truncate">Cars Orderd</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end widget-rounded-circle-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-right">
                                    ...
                                    <p class="text-muted mb-1 text-truncate">Containers</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end widget-rounded-circle-->
