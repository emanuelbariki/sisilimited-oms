...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-3">Track Order - <i><?=$orderdetails['0']['brandName'] ?> <?=$orderdetails['0']['makeName'] ?> <?=$orderdetails['0']['year'] ?></i></h4>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <? foreach ($workdone as $id => $R) {
                                if ($R['done'] == '0') {?>
                                    ...
                                    <!-- <span class="mdi mdi-close text-warning" style="display:block;"> <?=$R['statusName']?></span> -->
                                    
                                    <li>
                                        <h5 class="mt-0 mb-1">  <?=$R['statusName']?></h5>
                                        <p class="text-muted">Estimated delivery within few days</p>
                                    </li>
                                <?}else {?>
                                    <!-- <span class="mdi mdi-check-all text-success" style="display:block;"> <?=$R['statusName']?></span> -->
                                    <li class="completed">
                                        <h5 class="mt-0 mb-1"><?=$R['statusName']?></h5>
                                        <p class="text-muted">Updated On <?=$R['date']?></p>
                                    </li>
                                <?}
                            } ?>
