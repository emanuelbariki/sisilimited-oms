            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12" style="background-color: <?=CS_THEME?>!important; border-bottom: solid 1px <?=CS_THEME?>; border-top: solid 1px <?=CS_THEME?>;">
                        <div class="mt-1">
                            <h2 class="text-white text-center" style="font-weight: 900; text-transform: uppercase;">Acknowledgement Reciept</h2>
                        </div>
                    </div><!-- end col -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-2">
                        <div class="mt-3 float-right">
                            <p class="m-b-10"><strong>Payment Date : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp;<?=$paymentdetails[0]['doc']?></span></p>
                            <p class="m-b-10"><strong>Payment Status : </strong> <span class="float-right"><span class="badge <?=$badge?>"><?=$pamentstatus?></span></span></p>
                            <p class="m-b-10"><strong>Payment No. : </strong> <span class="float-right">#SLP <?=str_pad($paymentdetails[0]['id'], 3, "0", STR_PAD_LEFT)?> </span></p>
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        <h6>Recieved with thanks from;</h6>
                        <address>
                            ...
                            <table class="table mt-4 table-centered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Payments For the Purchace of a used <b><?=$orderData[0]['brandName']?>&nbsp;<?=$orderData[0]['makeName']?>&nbsp;<?=$orderData[0]['caryear']?></b>. 
                                    ...
                                    <?=number_format($paymentdetails[0]['paid_totalmount'])?></td>
                                </tr>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="clearfix pt-5">
                            ...
                            <!-- <div class="row">
                                <div class="clearfix">
                                    <div class="text-center col-sm-12">
                                        <b><p>"<?=numberTowords($paymentdetails[0]['paid_totalmount'])?>"</p></b>
                                    </div>
                                </div>
                            </div> -->
                           ...
                           <div class="row">
                               <div class="col-md-4">
                                    <?
                                        if ($paymentdetails[0]['payment_type'] == 1) {?>
                                            <small class="text-muted">
                                                Payments Done via <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['paymentMethod']?></span>
                                                <br>
                                            </small>
                                        <?}else if ($paymentdetails[0]['payment_type'] == 2) {?>
                                            <small class="text-muted">
                                                Payments Done via <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['paymentMethod']?></span>
                                                <br> 
                                                Cheque No. <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['chequeno']?></span>
                                                <br>
                                                Bank Name No. <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['bankname']?></span>
                                                <br>
                                            </small>
                                        <?}elseif ($paymentdetails[0]['payment_type'] == 3) {?>
                                            <small class="text-muted">
                                                Payments Done via <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['paymentMethod']?></span>
                                                <br> 
                                                Reference No. <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['chequeno']?></span>
                                                <br>
                                                Bank Name No. <span class="badge badge-sisi float-right"><?=$paymentdetails[0]['bankname']?></span>
                                                <br>
                                            </small>
                    ...
                    <div class="col-sm-6">
                        <div class="float-right">
                            <p><b>Sub-total:</b> <span class="float-right">Tzs <?=number_format($paymentdetails[0]['paid_totalmount'])?> /=</span></p>

                            <!-- <p><b>Discount (0%):</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; Tzs 0</span></p> -->
                            <!-- <input type="text" class="numbetowords" name="" value="<?=$GrandTotal?>"> -->
                            <h3 style="border-bottom: 1px solid #333; border-top: 1px solid #333; padding: 5px;" class="bg-sisi text-white">Tzs <?=number_format($paymentdetails[0]['paid_totalmount'])?> /=</h3>

                        </div>
                        <div class="clearfix"></div>

                        <div class="text-center col-sm-12">
                            <b><p>"<?=numberTowords($paymentdetails[0]['paid_totalmount'])?> ONLY"</p></b>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="clearfix pt-5">
                            <h6 class="text-muted">Issued By: <u><?=$paymentdetails[0]['createdby']?></u></h6>
            ...
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                    <a href="" class="text-success">
                        <span><img src="<?=CS_WHITE_LOGO?>" alt="" height="50"></span>
                    </a>
                </div>
                ...
                <form class="px-3" action="<?=url('orders','savepayment')?>" method="POST">
                    ...
                    <div class="cheque">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="bankname" name="payment[bankname]" placeholder="Bank Name">
                        </div>
                        <div class="form-group">
