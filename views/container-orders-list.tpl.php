    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">All Container Orders</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="?module=orders&action=view&id=<?= $R['id']?>"><i class="mdi mdi-check-all mr-2 text-muted font-18 vertical-middle"></i>View Order</a>
                                            <a class="dropdown-item" href="?module=leads&action=index&id=<?= $R['id']?>"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Edit Order</a>
                                            <a class="dropdown-item" href="?module=orders&action=invoice&id=<?= $R['id']?>"><i class="mdi mdi-cash-marker mr-2 text-muted font-18 vertical-middle"></i>Generate Invoice</a>
