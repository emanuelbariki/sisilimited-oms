    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Ports Module</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-0">Add Ports</h4>
                    <hr>
                    <div class="col-md-12">
                        <form action="<?=url('ports','add')?>" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="brandname" class="col-form-label">Port Name</label>
                                    <input type="text" class="form-control" id="brandname" placeholder="Port Name" name="ports[name]" value="<?=$name?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="country" placeholder="Country" name="ports[country]" value="<?=$country?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select id="statuss" class="form-control" name="ports[status]">
                            ...
                            <button type="submit" class="btn btn-primary waves-effect waves-light">Save Port</button>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-0">All Ports</h4><hr>
